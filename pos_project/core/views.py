...
from .models import (
    Articulo, GrupoArticulo, ItemOrdenCompraCliente, LineaArticulo,
    ListaPrecio, Cliente, OrdenCompraCliente, Vendedor, EstadoOrden, CanalCliente
)
...
def checkout(request): 
    ...
    try: 
        ...
        try: 
            ...
            tipo_id = CanalCliente.TipoIdentificacion.objects.first() 
...
def articulo_create(request): 
    if request.method == 'POST': 
        ...
        else: messages.warning(request, 'Por favor corrija los errores en el formulario.') 
    else: 
        form = ArticuloForm() 
        precio_form = ListaPrecioForm() 
    context = {
